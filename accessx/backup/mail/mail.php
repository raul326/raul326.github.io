...
$sendingAccountUsername     = 'request@sofiapulse.com';
$sendingAccountPassword     = 'request514!';

// Recipient (To:) Details  - Change this to the email details of who will receive all the emails from the website.
$recipientEmail             = 'joe@sofiapulse.com'; // REQUIRED value.
$recipientName              = 'Joe Younes';             // REQUIRED value.

// Email details            - Change these to suit your website needs
$emailSubject               = 'Newsletter and Updates - Tracingvoices'; // REQUIRED value. Subject of the email that the recipient will see
$websiteName                = 'Tracingvoices';                // REQUIRED value. This is used when a name or email is not collected from the website form

$timeZone					= 'Canada/Central';         // OPTIONAL, but some servers require this to be set.
